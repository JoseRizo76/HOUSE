...
.tarjeta::before{
  ...
  height: 600px;
  width: 600px;
  background-image: conic-gradient(red 40deg, transparent 120deg);
...
.texto{
  ...
  animation: textorgb 1.5s infinite alternate-reverse;
}
.fa-house-lock{
  position: absolute;
  z-index: 1;
...
@keyframes principal{
  ...
  100%{text-shadow: 1px 1px 1px pink;}
}
  @keyframes textorgb{
  0%{color: red;}
  33%{color: red;}
  33%{color: blue;}
  66%{color: blue;}
  66%{color:rgb(106, 255, 0);  
  text-shadow:  1px 1px 1px black;  }
  100%{text-shadow: 1px 1px 1px pink; color: black;}
  }
...
<div id="loading-message">
		<div class="container"> <p class="loading">Loading</p></div></div>
  <div class="contenedor">
    <form action='/login' method='get'>
      <div class="tarjeta"> 
        <div class="informacion">
          <h2 class="texto">LOGIN HOUSE</h2>
